            ...
            <nav class="navbar top-navbar navbar-expand-lg">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div style="background-color: #ffca2bd1;" class="navbar-brand">
                        <!-- Logo icon -->
                        <a href="index.html">
                            <img style="width: 65px;" src="{{ asset('Partenaire/assets/images/logo.jpeg') }}"
                             alt="" class="img-fluid">
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown"
                                ...
                                @if(auth()->user()->photo)
    <img src="{{ asset('public/images/Partenaire/' . auth()->user()->photo) }}" alt="user" class="rounded-circle" width="40">
@else
    <!-- Default image if user's photo doesn't exist -->
    <img src="{{ asset('public/images/Partenaire/default.jpg') }}" alt="default-user" class="rounded-circle" width="40">
@endif
