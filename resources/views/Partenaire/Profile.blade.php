                                ...
                                <form class="mt-4">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <img style="border-radius: 50% ; width:200px ; margin-left:30px ; margin-top:10px ; margin-bottom:20px"
                                                src="public/images/Partenaire/{{ $partenaire->photo }}" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="output2">
                                            <h4>{{ $partenaire->prenom }}</h4>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <div class="output2">
                                            <h4>{{ $partenaire->email }}</h4>
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="card-body">
                                ...
                                <form class="mt-4">
                                    <div class="form-group">
                                        ...
                                        <div class="output2">
                                            <h4>{{ $partenaire->annee_experience }} ans</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="output2">
                                            <h4>{{ $partenaire->metier }}</h4>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="ville">Ville</label>
                                        <div class="output2">
                                            <h4>{{ $partenaire->ville }}</h4>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="address">Adresse</label>
                                        <div class="output2">
                                            <h4>{{ $partenaire->address }}</h4>
                                        </div>
                                    </div>
                                        ...
                                        <form class="mt-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="slide-reviews__rating">
                                                    @for ($i = 0; $i < 5; $i++)
                                                        @if ($i < $averageRating)
                                                            <img src="Page_Principale/images/reviews/star-gold.svg"
                                                                alt="yellow star" />
                                                        @else
                                                            <img src="Page_Principale/images/reviews/star-grey.svg"
                                                                alt="gray star" />
                                                        @endif
                                                    @endfor
                                                </div>
