                                    ...
                                    <form action="{{ route('update.profile') }}" method="POST"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nom" name="nom"
                                                placeholder="Entrez votre nom" value="{{ $partenaire->name }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="prenom" class="form-label">Prénom :</label>
                                            <input type="text" class="form-control" id="prenom" name="prenom"
                                                placeholder="Entrez votre prénom" value="{{ $partenaire->prenom }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="email" class="form-label">Email :</label>
                                            <input type="email" class="form-control" id="email" name="email"
                                                placeholder="Entrez votre email" value="{{ $partenaire->email }}">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="metier" name="metier"
                                                placeholder="Entrez votre métier" value="{{ $partenaire->metier }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="ville" class="form-label">Ville :</label>
                                            <input type="text" class="form-control" id="ville" name="ville"
                                                placeholder="Entrez votre ville" value="{{ $partenaire->ville }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="annees_experience" class="form-label">Années d'expérience
                                                :</label>
                                            <input type="number" class="form-control" id="annees_experience"
