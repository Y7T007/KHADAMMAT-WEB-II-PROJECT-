            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Bonjour Mr. {{$partenaire->name}}</h3>
                                ...
                                <div class="d-flex align-items-center">
                                    <div>
                                        <div class="d-inline-flex align-items-center">
                                            <h2 class="text-dark mb-1 font-weight-medium">{{$commentCount}}</h2>

                                        </div>
                                        <h6 class=" font-weight-normal mb-0  text-truncate">Comments
                                        </h6>
                                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border-end ">
                            <div class="card-body" style="background-color: rgba(246, 122, 122, 0.758) ; border-radius:30px ;">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">{{$demandCount}}</h2>
                                            <h6 class=" font-weight-normal mb-0 w-100 text-truncate">interventions
                                        </h6>
                                    </div>
                                    <div class="ms-auto mt-md-3 mt-lg-0">
                        ...
                        <div class="card border-end ">
                            <div class="card-body" style="background-color: rgba(122, 246, 139, 0.758) ; border-radius:30px ; ">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <div class="d-inline-flex align-items-center">
                                            <h2 class="text-dark mb-1 font-weight-medium">{{$partenaire->note}}</h2>
                                            
                                        </div>
                                        <h6 style="" class=" font-weight-normal mb-0 w-100 text-truncate">Rating
                                        </h6>
                                    </div>
                                    <div class="ms-auto mt-md-3 mt-lg-0">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card ">
                            <div class="card-body" style="background-color: rgba(246, 122, 234, 0.758) ; border-radius:30px ;">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <h2 class="text-dark mb-1 font-weight-medium">{{$partenaire->rating_count}}</h2>
                                ...
                                <div class="mt-4 activity">
                                    ...
                                    <div class="d-flex align-items-start border-left-line">
                                        ...
                                        <div class="ms-3 mt-2">
                                            ...
                                            <p class="font-14 mb-2 ">Omar just demande service </p>
                                            <a onclick="window.location.href = '/comment';" href="javascript:void(0)"
                                            class="font-14 border-bottom pb-1 border-info">Voir</a>
