...
<body>
    ...
    <table id="zero_config" class="table table-striped table-bordered no-wrap">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    @if($clients->photo)
                    <img src="{{ asset('uploads/profile_pictures/' . $clients->photo) }}" alt="Photo de profil" class="profile-picture img-thumbnail rounded-circle custom-circle-img" style="width: 50px; height: 50px;">
                    @else
    ...
    <div class="slide-reviews__rating">
        ...
        @endfor
                ...
                <td>
                    <button class="btn btn-outline-danger btn-rounded" data-bs-toggle="modal" data-bs-target="#DeactivateModal" data-url="{{ route('deactivate.user') }}" data-user-id="{{ $clients->id }}">Deactivate</button>
                </td>
            </tr>
            @endforeach
        </tbody>
                                             ...
                                             <div class="modal-dialog modal-dialog-centered">
                                              ...
                                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                     ...
                                                     <div class="modal-body">
                                                              ARE YOU SURE YOU WANT TO DEACTIVATE THIS CLIENT'S ACCOUNT ?
                                                          </div>
