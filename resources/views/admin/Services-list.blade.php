...
<tbody>
    ...
    <tr>
       <td>{{ $service->service->nom }}</td>
        <td>{{ $service->client->name }}</td>
        <td>{{ $service->partenaire->name }}</td>
      
        <td>{{ $service->date }}</td>
        <td>
            @if($service->statut == 'Accepter')
                <button class="btn btn-success btn-rounded" style="pointer-events: none;">Accepter</button>
            @elseif($service->statut == 'Refuser')
                <button class="btn btn-danger btn-rounded" style="pointer-events: none;">Refuser</button>
            @else
        ...
        <td>
                    <button class="btn btn-outline-danger btn-rounded" data-bs-toggle="modal" data-bs-target="#CancelModal" data-url="{{ route('cancel.service') }}" data-demande-id="{{ $service->id }}">Cancel</button>
                </td>
    ...
    @endforeach
                                                 ...
                                                 <!-- POP UP FOR Canceling a service  -->
                                             ...
                                             <div class="modal-dialog modal-dialog-centered">
                                              ...
                                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    ...
                                                    <button type="button" class="btn btn-secondary btn-rounded" data-bs-dismiss="modal">exit</button>
                                                     <button type="button" class="btn btn-danger btn-rounded" > YES </button>
    ...
    <script src="{{ asset('js/cancel-service.js') }}"></script>
    <!--Custom JavaScript -->
