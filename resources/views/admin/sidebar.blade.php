                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="{{route('Partenaire')}}"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Partners List
                                </span></a>
                        </li>

                        <li class="sidebar-item"> <a class="sidebar-link" href="{{route('Deactivated_Accounts')}}"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Deactivated Accounts
                                </span></a>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="{{route('Commentaires')}}"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
