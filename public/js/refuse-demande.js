...
$('#refuseModal').on('show.bs.modal', function (event) {
    ...
    modal.find('.btn-danger').attr('data-client-id', clientId);
    modal.find('.btn-danger').attr('data-service-id', serviceId);
...
$('.btn-danger').on('click', function () {
    ...
    $('#refuseModal').modal('hide');
            ...
            $('#refuseModal').attr('aria-hidden', 'true');
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            Swal.fire({
                title: "Refused!",
                text: "The service has been Refused.!!!",
                icon: "success",
                showClass: {
                    popup: `
                        animate__animated
